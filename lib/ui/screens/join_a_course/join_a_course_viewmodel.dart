...
class JoinACourseScreenViewModel extends BaseViewModel {
  ...
  joinCourse() async {
    ...
    try {
      ...
      ResponseData _responseData =
          await _courseService.joinCourse(userId, _courseCode);
      print(
          "JoinACourseScreenViewModel[28]- Response: ${_responseData.toJson()}");
      if (_responseData != null &&
          _responseData.status == 1 &&
          _responseData.data['joined'] == '1') {
        _dialogService
        ...
        print(
            "JoinACourseScreenViewModel[44]- Response: ${_responseData.toJson()}");
      ...
      print('JoinACourseScreenViewModel[52]- : Error - ${e.toString()}');
      _snackbarService.showCustomSnackBar(
        variant: SnackbarType.error,
        message: '$e',
      );

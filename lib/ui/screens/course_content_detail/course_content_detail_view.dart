...
class CourseContentDetailScreenView extends StatelessWidget {
  ...
  const CourseContentDetailScreenView(
      {Key key, this.course, this.courseSectionContent})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<CourseContentDetailScreenViewModel>.reactive(
      onModelReady: (model) async =>
          await model.loadData(course, '5isPWNr_Jqs', courseSectionContent.id),
                  ...
                  child: Column(
                    ...
                    children: [
                      Container(
                        ...
                        child: Text(courseSectionContent.title ?? course.name),
                      ),
                      Container(
                        padding: EdgeInsets.all(16.0),
